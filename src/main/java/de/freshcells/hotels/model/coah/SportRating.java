...
public class SportRating implements Serializable {
    ...
    public SportRating(double overall, double single, double couple, double family, double friends, double beach, double wintersport, double other) {
